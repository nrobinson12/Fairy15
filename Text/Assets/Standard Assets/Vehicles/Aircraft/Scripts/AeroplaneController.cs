...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : NetworkBehaviour
    {
        ...
        private void ControlThrottle()
        {
            ...
            //Debug.Log("ThrottleBefore: " + ThrottleInput);
            // Adjust throttle based on throttle input (or immobilized state) clamp used to be 0, 1
            Throttle = Mathf.Clamp(Throttle + ThrottleInput*Time.deltaTime*m_ThrottleChangeSpeed, 0, ThrottleInput);
            //Debug.Log("TThrottle: " + Throttle);
